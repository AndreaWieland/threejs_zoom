...
const camera: THREE.PerspectiveCamera = new THREE.PerspectiveCamera(85, window.innerWidth / window.innerHeight, 0.1, 1000)
camera.position.z = 3
...
const orb_geometry: THREE.SphereGeometry = new THREE.SphereGeometry(0.2,32,32)
const orb_material: THREE.MeshStandardMaterial = new THREE.MeshStandardMaterial({ 
    roughness: 0.0, 
    metalness: 0.95, 
    map: texture,
    bumpMap: texture,
...
const orb1: THREE.Mesh = new THREE.Mesh(orb_geometry, orb_material)
scene.add(orb1)
const orb2: THREE.Mesh = new THREE.Mesh(orb_geometry, orb_material)
scene.add(orb2)
const orb3: THREE.Mesh = new THREE.Mesh(orb_geometry, orb_material)
scene.add(orb3)
